...
class PacientesC{
    ...
    public function CrearPacienteC(){
        ...
        if(isset($_POST["rolP"])){
            ...
            $datosC = array("Apellido"=>$_POST["Apellido"], "Nombre"=>$_POST["Nombre"], "documento"=>$_POST["documento"], "clave"=>$_POST["clave"], "Rol"=>$_POST["rolP"]);
    ...
    public function ActualizarPacienteC(){
        ...
        if(isset($_POST["Pid"])){
            ...
            $datosC = array("id"=>$_POST["Pid"], "Apellido"=>$_POST["ApellidoE"], "Nombre"=>$_POST["NombreE"],  "documento"=>$_POST["documentoE"], "clave"=>$_POST["claveE"]);
        ...
        if(isset($_POST["Pid"])) {
            ...
            if (isset($_FILES["imgPerfil"]["tmp_name"]) && !empty($_FILES["imgPerfil"]["tmp_name"])) {
                ...
                if ($_FILES["imgPerfil"]["type"] == "image/png") {
                    ...
                    $rutaImg = "Vistas/img/Paciente/paciente" . $nombre . ".png";
                ...
                if ($_FILES["imgPerfil"]["type"] == "image/jpeg") {
                    ...
                    $rutaImg = "Vistas/img/Paciente/paciente" . $nombre . ".jpg";
            ...
            $datosC =array("id"=>$_POST["Pid"],"Nombre"=>$_POST["nombrePerfil"], "Apellido"=>$_POST["apellidoPerfil"],"clave"=>$_POST["clavePerfil"],
                "documento"=>$_POST["documentoPerfil"],"Foto"=>$rutaImg);
