        ...
        echo '<form method="post" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<div class="col-md-6 col-xs-12">
						...
						<h2>Usuario:</h2>
						<input type="text" class="input-lg" name="usuarioP" value="'.$resultado["documento"].'">
        ...
        if(isset($_POST["Aid"])){
            ...
            if(isset($_FILES["imgP"]["tmp_name"]) && !empty($_FILES["imgP"]["tmp_name"])){
                ...
                if($_FILES["imgP"]["type"] == "image/jpeg"){
                    ...
                    $rutaImg = "Vistas/img/Usuario/A-".$nombre.".jpg";
                ...
                if($_FILES["imgP"]["type"] == "image/png"){
                    ...
                    $rutaImg = "Vistas/img/Usuario/A-".$nombre.".png";
            ...
            $datosC = array("id"=>$_POST["Aid"], "documento"=>$_POST["usuarioP"], "clave"=>$_POST["claveP"], "nombre"=>$_POST["nombreP"],
                "apellido"=>$_POST["apellidoP"], "foto"=>$rutaImg);
