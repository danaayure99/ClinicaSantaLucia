...
class DoctoresC{
    ...
    public function CrearDoctorC(){
        ...
        if(isset($_POST["rolD"])){
            ...
            $datosC = array("Rol"=>$_POST["rolD"], "apellido"=>$_POST["apellido"], "nombre"=>$_POST["nombre"], "sexo"=>$_POST["sexo"],  "id_consultorio"=>$_POST["consultorio"], "documento"=>$_POST["documento"], "clave"=>$_POST["clave"]);
    ...
    public function ActualizarDoctorC(){
        ...
        if(isset($_POST["Did"])){
            ...
            $datosC = array("id"=>$_POST["Did"], "apellido"=>$_POST["apellidoE"], "nombre"=>$_POST["nombreE"], "sexo"=>$_POST["sexoE"], "documento"=>$_POST["documentoE"], "clave"=>$_POST["claveE"]);
    ...
    public function IngresarDoctorC(){
        ...
        if(isset($_POST["usuario-Ing"])){
            ...
            if(preg_match('/^[a-zA-Z0-9]+$/', $_POST["usuario-Ing"]) && preg_match('/^[a-zA-Z0-9]+$/', $_POST["clave-Ing"])){
                ...
                $datosC = array("documento"=>$_POST["usuario-Ing"], "clave"=>$_POST["clave-Ing"]);

                $resultado = DoctoresM::IngresarDoctorM($tablaBD, $datosC);

                if($resultado["documento"] == $_POST["usuario-Ing"] && $resultado["clave"] == $_POST["clave-Ing"]){
        ...
        if(isset($_POST["Did"])){
            ...
            if(isset($_FILES["imgPerfil"]["tmp_name"]) && !empty($_FILES["imgPerfil"]["tmp_name"])){
                ...
                if($_FILES["imgPerfil"]["type"] == "image/png"){
                    ...
                    $rutaImg = "Vistas/img/Doctor/Doc-".$nombre.".png";
                ...
                if($_FILES["imgPerfil"]["type"] == "image/jpeg"){
                    ...
                    $rutaImg = "Vistas/img/Doctor/Doc-".$nombre.".jpg";
            ...
            $datosC = array("id"=>$_POST["Did"], "nombre"=>$_POST["nombrePerfil"], "apellido"=>$_POST["apellidoPerfil"], "documento"=>$_POST["documentoPerfil"],
